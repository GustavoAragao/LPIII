public class Lampada{
    ...
    //Costrutor
    public Lampada(String fabricante, String cor, double potenciaW, double tensao, int quantStock, double valor){
        this.setPotenciaW(potenciaW);
        this.setCor(cor);
        this.setFabricante(fabricante);
        this.setTensao(tensao);
        this.setQuantStock(quantStock);
        this.setValor(valor);
        this.setQuantVendida(0);
        this.setQuantVendaAnterior(0);
    }
  ...
  public void setQuantVendaAnterior(int quant){
    ...
    public void mostraVenda(){
        ...
        System.out.printf("Potência: %.2fw\n", getPotenciaW());
        System.out.printf("Tensão: %.2fv\n", getTensao());
        System.out.printf("Quantidade: %d\n", getQuantVendida());
        System.out.printf("Valor único: R$ %.2f\n", getValor());
